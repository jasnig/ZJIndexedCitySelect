...
@interface ZJCityViewControllerThree ()<UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, UISearchControllerDelegate> {
...
@implementation ZJCityViewControllerThree
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZJCityTableViewCellOne *cell = [tableView dequeueReusableCellWithIdentifier:kCellId];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        // 注册cell
        [tableView registerClass:[ZJCityTableViewCellOne class] forCellReuseIdentifier:kCellId];
        // 行高度
